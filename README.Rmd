...
A simple framework for searching annotated corpora for grammatical constructions in context.  
...
Concatenate and re-code attested `gramx` results in annotated data frame:
